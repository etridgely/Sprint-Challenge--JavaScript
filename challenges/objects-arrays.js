...
const uni = graduates.filter((u) => {
  return u.university.includes("Uni");
});
console.log(uni);
...
*/
const lowerPopulation = zooAnimals.filter((v) => {
  return v.population < 5;
});
...
*/
const populationTotal = zooAnimals.reduce((total, sum) => {
